  ...
  public function rules()

    {
        return [
            ...
            [['TiposId_fk8', 'AppServWebVers','TiposId_fk9', 'TiposId_fk10', 'TiposId_fk11', 'TiposId_fk13', 'TiposId_fk15', 'TiposId_fk56'], 'required'],
...
*/
  ...
  public function beforeValidate(){
    ...
    if ($this->TiposId_fk56) {
      $this->TiposId_fk56 = implode(',',(array)$this->TiposId_fk56);
    }
    if ($this->AppEntiImag) {
