     ...
     public function afterSave($insert, $changedAttributes)
    {
        ...
        if (!$insert)
        {
            ...
            foreach ($rows as $key => $value)
            {
                ...
                {
                    $var[7] = "tiemexp => ".$rows['ParTiemExpi'];
                }
