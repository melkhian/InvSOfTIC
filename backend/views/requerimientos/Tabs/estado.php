...
<?php // NOTE: El siguiente código genera una forma dinámica para manejar relaciones 1:N
      ...
      <div class="row">
        <div class="panel panel-default">
          <div class="panel-heading"><h4><i class="	glyphicon glyphicon-equalizer"></i> ESTADO DEL REQUERIMIENTO</h4></div>
          <div class="panel-body">
            <?php DynamicFormWidget::begin([
              ...
              'model' => $modelsEstrequerimientos[0],
              'formId' => 'dynamic-form',
              'formFields' => [
                'VDReqDocu',
              ],
            ...
            <div class="container-items1"><!-- widgetContainer -->
              <?php foreach ($modelsEstrequerimientos as $i => $modelEstrequerimientos): ?>
                <div class="item1 panel panel-default"><!-- widgetBody -->
                  ...
                  <div class="panel-body">
                    ...
                    if (! $modelEstrequerimientos->isNewRecord) {
                      echo Html::activeHiddenInput($modelEstrequerimientos, "[{$i}]EReqId");
                    }
                    ?>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <?= $form->field($modelEstrequerimientos, "[{$i}]EReqFech")->widget( DatePicker::className(),
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <?= $form->field($modelEstrequerimientos, "[{$i}]EReqEsta")->textarea(['maxlength' => true, 'rows'=>3]) ?>
                      </div>

                      <div class="row">
                        <?= $form->field($modelEstrequerimientos, "[{$i}]EReqFechSist")->hiddenInput(['maxlength' => true])->label(false); ?>
                      </div>
                  </div><!-- .row -->
                </div>
              <?php endforeach; ?>
