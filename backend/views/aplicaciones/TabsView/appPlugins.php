        ...
        <?php foreach ($modelsAppplugins as $i => $modelAppplugins): ?>
          <div class="item1 panel panel-default"><!-- widgetBody Se agrega el número 1 para diferenciarlo de otros similares DENTRO DEL MISMO FORMULARIO (Debe de ser constante en todo el widget)-->
            ...
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <?= $form->field($modelAppplugins, "[{$i}]APluNomb")->textInput(['maxlength' => true, 'disabled' => true]) ?>
                </div>
                <div class="col-sm-6">
                  <?= $form->field($modelAppplugins, "[{$i}]APluLice")->textInput(['maxlength' => true, 'disabled' => true]) ?>
                </div>
              </div><!-- .row -->
              <div class="row">
                <div class="col-sm-12">
                  <?= $form->field($modelAppplugins, "[{$i}]APluDesc")->textarea(['maxlength' => true, 'disabled' => true, 'rows' => '2']) ?>
                </div>
              </div><!-- .row -->
            </div>
          </div>
