  ...
  <div class="col-sm-4">
    ...
    <div class="col-sm-4">
      <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          <?= $form->field($model, 'AppServPues1')->textInput(['maxlength' => true]) ?>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <?= $form->field($model, 'AppServPues2')->textInput(['maxlength' => true]) ?>
          </div>
        </div>
      </div>
                ...
                <div class="item7 panel panel-default"><!-- widgetBody -->
                  ...
                  <div class="panel-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <?= $form->field($modelAppinteractua, "[{$i}]AIntOtroCual")->textInput(['maxlength' => true]) ?>
                      </div>
                    </div>
                  </div><!-- .row -->
                </div>
      ...
      <?= $form->field($model, 'AppOtroCual21')->textInput(['maxlength' => true]) ?>
