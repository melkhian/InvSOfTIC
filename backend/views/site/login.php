...
if(Yii::$app->session->hasFlash('fail')){
  ...
  echo "<div class='alert alert-danger' style='text-align: center'>".  Yii::$app->session->getFlash('fail') . "<button type='button' class='close' data-dismiss='alert' aria-label='Cerrar'>
